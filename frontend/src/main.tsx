...
type TimelineTone = 'muted' | 'running' | 'success' | 'error';
...
function buildTimeline(messages: MessageProjection[], runs: RunProjection[], events: AppEvent[]): TimelineItem[] {
...
function eventToTimelineItem(event: AppEvent): TimelineItem | undefined {
